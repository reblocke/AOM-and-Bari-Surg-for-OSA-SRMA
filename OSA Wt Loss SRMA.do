...
args workbook_dir output_root
if "`workbook_dir'" == "" local workbook_dir "."
if "`output_root'" == "" local output_root "Results and Figures"

local source_workbook "`workbook_dir'/Data Extraction Table.xlsx"
capture confirm file "`source_workbook'"
if _rc {
    di as err "Could not find `source_workbook'. Run this script from the repository root or pass the workbook directory as the first argument."
    exit 601
}

local results_dir "`output_root'/$S_DATE"
local log_dir "`results_dir'/Logs"
local derived_dir "outputs/stata"
...
log using "`log_dir'/osa_wt_loss_srma.log", replace text
...
save "`derived_dir'/osa_antiobesity_srma", replace
...
* Data analysis
use "`derived_dir'/osa_antiobesity_srma", clear
...
graph export "`results_dir`/Figure 3- AHI Diff by Type and Intervention.png", as(png) name("Graph") replace
...
graph export "`results_dir`/FigureS6 - AHI Diff by Intervention.png", as(png) name("Graph") replace
...
graph export "`results_dir`/AHI Diff by Intervention Class.png", as(png) name("Graph") replace
...
graph export "`results_dir`/AHI Diff by Intervention Type.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Figure 2 AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Figure 4- Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Figure S5- Wt Loss v AHI Diff Meta Regress by type.png", as(png) name("Graph") replace
...
use "`derived_dir`/osa_antiobesity_srma", clear //restore
...
graph export "`results_dir`/Figure S6-1- AHI Diff by Type and Intervention.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Figure S6-2 AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Figure S6-3- Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement Figure - ESS Diff by Intervention Type.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement Figure - ESS Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - Wt Loss v ESS Diff Meta Regress.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - Excl Furlan - AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - Excl Furlan - AHI Diff by Surg v Med.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - Excl Furlan - Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
...
//10% threshold
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) columnopts(_data, format(%4.1f)) subgroup ( ten_perc_wt ) title("") scheme(white_w3d) note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl CAI - AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace

//By Intervention type, RCTs Reporting AHI Absolute Change and Percent Weight Loss; Excluding CAIs 
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) esrefline(lcolor(gs3) lpattern(dash_dot)) columnopts(_data, format(%4.1f)) subgroup (studycategory) title("") note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl CAI - AHI Diff by Surg v Med.png", as(png) name("Graph") replace
...
estat bubbleplot, reweighted ytitle("Control-Subtracted AHI change (events/hr)") xtitle(" Percent weight change(%)") title("") note("") mlabel(study_label) mlabsize(vsmall) mlabposition(3) mlabangle(25) xline(0, lcolor(gs10)) yline(0, lcolor(gs10)) scheme(white_w3d) legend(order(1 "95% CI" 3 "Meta-regression line") rows(2) pos(6) ring(0))
graph export "`results_dir`/Supplement - Excl CAI - Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
...
//10% threshold
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) columnopts(_data, format(%4.1f)) subgroup ( ten_perc_wt ) title("") scheme(white_w3d) note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl Bakker - AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace

//By Intervention type, RCTs Reporting AHI Absolute Change and Percent Weight Loss; Excluding Bakker
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) esrefline(lcolor(gs3) lpattern(dash_dot)) columnopts(_data, format(%4.1f)) subgroup (studycategory) title("") note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl Bakker - AHI Diff by Surg v Med.png", as(png) name("Graph") replace
...
estat bubbleplot, reweighted ytitle("Control-Subtracted AHI change (events/hr)") xtitle(" Percent weight change(%)") title("") note("") mlabel(study_label) mlabsize(vsmall) mlabposition(3) mlabangle(25) xline(0, lcolor(gs10)) yline(0, lcolor(gs10)) scheme(white_w3d) legend(order(1 "95% CI" 3 "Meta-regression line") rows(2) pos(6) ring(0))
graph export "`results_dir`/Supplement - Excl Bakker - Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - AHI Diff by RoB.png", as(png) name("Graph") replace
...
graph export "`results_dir`/Supplement - Weight Loss by RoB.png", as(png) name("Graph") replace
...
//10% threshold
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) columnopts(_data, format(%4.1f)) subgroup ( ten_perc_wt ) title("") scheme(white_w3d) note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl High Risk - AHI Diff by 10 Perc Wt Loss.png", as(png) name("Graph") replace

//By Intervention type, RCTs Reporting AHI Absolute Change and Percent Weight Loss; Excluding High Risk
meta forestplot, random(reml) nooverall noohetstats noohomtest noosigtest nullrefline(lcolor(gs3) favorsright("Favors control") favorsleft("Favors Intervention")) esrefline(lcolor(gs3) lpattern(dash_dot)) columnopts(_data, format(%4.1f)) subgroup (studycategory) title("") note("") xtitle("Control Subtracted Change in AHI (events/hr)")
graph export "`results_dir`/Supplement - Excl High Risk - AHI Diff by Surg v Med.png", as(png) name("Graph") replace
...
estat bubbleplot, reweighted ytitle("Control-Subtracted AHI change (events/hr)") xtitle(" Percent weight change(%)") title("") note("") mlabel(study_label) mlabsize(vsmall) mlabposition(3) mlabangle(25) xline(0, lcolor(gs10)) yline(0, lcolor(gs10)) scheme(white_w3d) legend(order(1 "95% CI" 3 "Meta-regression line") rows(2) pos(6) ring(0))
graph export "`results_dir`/Supplement - Excl High Risk - Wt Loss v AHI Diff Meta Regress.png", as(png) name("Graph") replace
